...
import { LogOut, Home, Users, TrendingUp, BarChart3, FileText, Clock, AlertTriangle, Cloud, DollarSign } from 'lucide-react';
...
export default function FirebaseDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {showNewClient && (
        <FirebaseClientForm onClose={() => setShowNewClient(false)} />
      )}
    </div>
  );
}
